...
\setlength{\cardheight}{8.3cm}
\setlength{\cardwidth}{10.5cm}
...
\begin{tikzpicture}[remember picture, overlay]
    \filigrane{#1}{#2}
    % Graphics
    %\node[inner sep=0pt] (russell) at (0.1,2.0){
    %    \includegraphics[opacity=0.1, max size={\pagewidth}{\pageheight}, keepaspectratio]{.png}
    %};
...
\lipsum[2]
\newline
\includegraphics[max size={0.25\textwidth}{0.2\textheight}, center, keepaspectratio]{QCM/MATIERE/ID_QUESTION/qrcode.png}
