...
\setlength{\east}{2cm}
\setlength{\backeastright}{9cm}
\setlength{\backwestright}{1.3cm}
\setlength{\backeastleft}{3cm}
\setlength{\backwestleft}{6cm}
...
\newcommand{\bgimage}[8]{
    \begin{tikzpicture}[remember picture, overlay]
        ...
        \else
            ...
            % CENTER WEST
            \node [align=left, opacity=1] at ([xshift=-\backeastright, yshift=\middleleft]0,0) {
                \small
                \color{uniscielpink}
                \textsf{\textit{Vous pouvez revoir le cours en suivant le lien}}\\
                \small
            ...
            % CENTER EAST
            \node [align=left, opacity=1] at ([xshift=\backwestright, yshift=\middleleft]0,0) {
                \small
                \color{uniscielpink}
                \textsf{\textit{Vous pouvez revoir le cours en suivant le lien}}\\
                \small
            ...
            % SOUTH WEST
            \node [align=left, opacity=1] at ([xshift=-\backeastright, yshift=\southleft]0,0) {
                \small
                \color{uniscielpink}
                \textsf{\textit{Vous pouvez revoir le cours en suivant le lien}}\\
                \small
            ...
            % SOUTH EAST
            \node [align=left, opacity=1] at ([xshift=\backwestright, yshift=\southleft]0,0) {
                \small
                \color{uniscielpink}
                \textsf{\textit{Vous pouvez revoir le cours en suivant le lien}}\\
                \small
