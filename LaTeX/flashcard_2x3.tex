...
\usepackage{graphicx}
\graphicspath{{./images/home_print/}}
...
\begin{tikzpicture}[remember picture, overlay]
    \node [align=left, opacity=1] at ([xshift=3.1cm, yshift=-2.97cm]current page.center) {
        \color{uniscielgrey}
        \textsf{\textit{Réponse}}
    };
    \node [align=left, opacity=1] at ([xshift=6.6cm, yshift=-2.96cm]current page.center) {
        \color{uniscielgrey}
