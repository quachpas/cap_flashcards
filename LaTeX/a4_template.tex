        ...
        \AddToShipoutPictureBG*{    
            \begin{tikzpicture}[remember picture, overlay]
                ...
                %%%%%% FC ONE
                    ...
                    \node at ([xshift = 5.25 cm, yshift = -7.5 cm]current page.north west) {
                        \includesvg[width = 0.8\cardwidth]{\frontfooter}
                    };
                    % Subject icon
                    \node [opacity = 1] at ([xshift = 1.5 cm, yshift = -1.125 cm]current page.north west) {
                        \includesvg[height = 0.15\cardheight]{icons/\subjecticon}
                    };
                    % Subject text
                    \node [opacity = 1] at ([xshift = 3.5 cm, yshift = -0.85 cm]current page.north west) {
                        \color{white}
                        \huge
                        \textsf{\FCone@subject}
                    };
                    % Theme
                    \node [opacity = 1] at ([xshift = 7 cm, yshift = -2.25 cm]current page.north west) {
                    ...
                    % Complexity level
                    \node [opacity=1] at ([xshift = 2.75 cm, yshift = -7 cm]current page.north west) {
                        \color{uniscielpink}
