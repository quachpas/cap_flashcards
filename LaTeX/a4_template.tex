...
\begin{tikzpicture}[remember picture, overlay]
    \node [align=left, opacity=1] at ([xshift = 7 cm, yshift = -2.1 cm]current page.north west) {
                \color{white}
                \normalsize
                \textsf{\textit{Réponses}}
            };
    \node [align=left, opacity=1] at ([xshift = 7.5 cm, yshift = -2.1 cm]current page.north west) {
                \color{white}
