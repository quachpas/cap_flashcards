...
\usepackage{xcolor}
\definecolor{unisciel-blue}{HTML}{0492bf}
\definecolor{unisciel-pink}{HTML}{e7215a}
\definecolor{unisciel-grey}{HTML}{676868}

\usepackage{fontspec}
\setsansfont{avgr45w.ttf}[
    BoldFont       = avgr65w.ttf,
    ItalicFont     = avgr46w.ttf,
    BoldItalicFont = avgr66w.ttf,
]
    ...
    \cardfrontfoot{
        \begin{center}
            \begin{minipage}[l]{0.7\linewidth}
                ...
                \textcolor{unisciel-pink}{\textsf{#1}}
            \end{minipage}%
            \hfill
...
\newcommand{\cardfrontheader}[3]{
    \begin{center}
        \begin{minipage}[l]{0.17\linewidth}
            \includesvg[height=15.5mm]{icons/physique}
        \end{minipage}%
        \hspace{5mm}
        \begin{minipage}[r]{0.75\linewidth}
            %\vspace{-\baselineskip}
            \textit{\textsf{#1}} -- \textsf{#2}\\
            \rule[1.3mm]{2cm}{0.1mm}\\
            \textsf{#3}\\
            \textsf{#3}
        \end{minipage}
    \end{center}
...
% --- FONT SIZE --- %
\cardfrontstyle[\small\slshape]{empty}
...
\newcommand{\filigrane}[2]{
    ...
    \ifoddpage
        ...
        \fill[color = black, opacity=0.1,pattern=custom dots, dotsize=#1mm, dotspread=#2mm] (-0.495\paperwidth,-0.495\paperheight) rectangle (0.495\paperwidth,0.495\paperheight);
    \else
        \fill[color = black, opacity=0.1,pattern=custom dots, dotsize=#1mm, dotspread=#2mm] (-0.495\paperwidth,-0.495\paperheight) rectangle (0.495\paperwidth,0.495\paperheight);
    \fi
}
